...
import { Bot, Zap, Cpu, MessageSquare, LayoutDashboard, PhoneCall } from "lucide-react";
  ...
  const leaders = [
    {
      ...
      message:
        "Dedicated to scaling UAE businesses through secure, autonomous AI ecosystems. My mission is to drive 10x operational efficiency and maximize ROI for our partners by deploying high-trust automation that works 24/7.",
      image: "/images/tanvir.jpeg",
      imagePosition: "center 20%" // Adjusted for better face view
    },
    {
      ...
      message:
        "Building the future of automation in Pakistan by transforming complex manual workflows into seamless AI-driven growth engines. We don't just write code; we build intelligent systems that increase your sales and slash overhead costs.",
    ...
    },
    {
      ...
      message:
        "Ensuring customer satisfaction is at the heart of SM Technology. We specialize in modernizing business flows with ethical AI, making sure every automation we build results in measurable success and sustainable international growth.",
      image: "https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?q=80&w=1200&auto=format&fit=crop", // More professional Asian/Pakistani executive look
    ...
    <section id="management" className="section-shell py-10 bg-slateDeep/30">
      ...
      <div className="mt-8 grid gap-8 md:grid-cols-3">
        {leaders.map((leader) => (
          ...
          >
            {/* Image Container - Fixed Aspect Ratio (Square/1:1) */}
            ...
            {/* Content Area - Flex Grow for Equal Height */}
    ...
    <section id="services" className="section-shell py-10 relative overflow-hidden">
      ...
      <div className="text-center mb-8">
        ...
        <p className="mt-4 text-slate-400 max-w-2xl mx-auto italic">
          "We build intelligent systems that increase your sales and streamline your business operations."
        </p>
      </div>
            ...
            <div className="relative z-10">
              ...
              <div className="mb-6 flex h-20 w-20 items-center justify-center rounded-2xl bg-slate-900/50 border border-white/10 group-hover:scale-110 transition-transform duration-500 p-2 shadow-inner">
                <img 
                  ...
                  onError={(e) => {
                    e.currentTarget.src = "https://via.placeholder.com/150?text=AI";
                  }}
                />
              </div>
  ...
  const completedData = [
    {
      ...
      href: "https://auto-facebook-poster-final.vercel.app",
    ...
    },
    {
      ...
      href: "https://linkdin-hunter.vercel.app",
    ...
    },
    {
      ...
      href: "https://ai-synopsis-tool.vercel.app",
    ...
    },
    {
      ...
      href: "https://uswa-colg-gpt.vercel.app",
    ...
    },
    {
      ...
      // ✅ High-Quality 3D Fashion & Shoes Icon
      image: "https://cdn-icons-png.flaticon.com/512/3659/3659914.png", 
      href: "https://bukhari-estore.vercel.app",
    ...
    },
    {
      ...
      href: "https://ali-sale-agent-ta14.vercel.app",
...
export function Testimonials() {
  const testimonials = [
    {
      text: "SM Technology shipped our AI funnel in record time. Their automation logic is flawless.",
      role: "COO, Retail Group",
      rating: 5,
      date: "3 month ago"
    },
    {
      text: "The LinkedIn Hunter tool they built for us has completely transformed our B2B lead generation process.",
      role: "Manager Operations, Global Outreach",
      rating: 5,
      date: "1 month ago"
    },
    {
      text: "Exceptional work on our School ERP. The AI integration for student queries is saving us 20+ hours weekly.",
      role: "Principal, Uswa Group of Colleges",
      rating: 5,
      date: "3 days ago"
    },
    {
      text: "Professional, fast, and very technical. They don't just code; they build business solutions.",
      role: "CEO, TechLaunch Solutions",
      rating: 5,
      date: "Just now"
    },
    {
      text: "Our WhatsApp sales bot is closing deals even while we sleep. SM Tech is the best in the business.",
      role: "Director Marketing, Innovate Pro",
      rating: 5,
      date: "2 month ago"
    },
    {
      text: "Highly secure and scalable E-commerce architecture. Their dashboard is world-class.",
      role: "Owner, Bukhari Retail Group",
      rating: 5,
      date: "2 weeks ago"
    }
  ...
  return (
    <section id="testimonials" className="section-shell py-10 bg-transparent">
      <div className="text-center mb-8">
        ...
        <p className="mt-4 text-slate-400 italic">"Real stories from businesses we've transformed."</p>
      </div>
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
        {testimonials.map((t, i) => (
          ...
          >
            ...
            <p className="text-[15px] leading-relaxed text-slate-200 italic mb-6">
              &ldquo;{t.text}&rdquo;
            </p>

            <div className="pt-6 border-t border-white/10 flex justify-between items-center">
              <div>
                <p className="text-xs font-bold uppercase tracking-widest text-neonBlue">
                  {t.role}
                </p>
